...
const PhotoSyncTable = ({ Props, onPageChange, voterCount }) => {
    console.log(Props, "//")
                ...
                <table className="w-full bg-white border border-gray-200">
                    <thead>
                        <tr className="bg-gray-200 text-gray-600 text-sm leading-normal">
                            {/* Table Headers */}
                            <th className="px-1 py-2 border border-gray-300">बूथ क्र.</th>
                            <th className="px-1 py-2 border border-gray-300">अ नं.</th>
                            <th className="px-1 py-2 border border-gray-300">सिंक्रोनाईज</th>
                        </tr>
                    </thead>
